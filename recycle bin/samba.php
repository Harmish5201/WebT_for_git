    ...
    <div class="BoxForContents" id="box">
        ...
        <table class="ProductTable">
            <tr>
                <td class="ProductImg">
                    <div id="productSlider">
                        <div id="sliderWrapper">
                            <img src="../img/adidas Samba.jpeg" alt="adidas Samba 1">
                            <img src="../img/adidas Samba 2.jpeg" alt="adidas Samba 2">
                        </div>
                ...
                <td class="ProductInfo">SAMBA ORIGINALS<br>
                    From football boots to streetwear favorites. With its clean low-top silhouette, soft leather upper
                    with suede overlays and natural rubber outsole, the Samba is a real evergreen and fits anytime and
                    anywhere.<br>
