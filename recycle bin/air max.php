        ...
        <div class="BoxForContents" id="box">
			...
			<table class="ProductTable">
				<tr>
                    ...
                    <td class="ProductInfo">As Nike's first everyday Air Max, the Nike Air Max 270 offers comfort and style. The design was inspired by Air Max icons and shows Nike's greatest innovation with its large window and fresh colors.<br> 
