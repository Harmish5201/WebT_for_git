        ...
        <div class="BoxForContents" id="box">
			...
			<table class="ProductTable">
				<tr>
					<td class="ProductImg">
                        <div id="productSlider">
                            <div id="sliderWrapper">
                                <img src="../img/puma roma.jpeg" alt="Roma 1">
                                <img src="../img/puma roma 2.jpeg" alt="Roma 2">
                            </div>
					...
					<td class="ProductInfo">Born in 1968, the PUMA Roma was originally created to celebrate the Italian Euro Cup win – and become a sport-turned-street sensation overnight. Today, over 50 years later, the Roma is back with its signature sleek look and gum rubber sole.<br> 
						<form action="#" class="ProductForm">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>:<input type="number" placeholder=" Euro(€)" id="priceWOTax" min="50" oninput="getTotalPrice(this.value)"></td>
                                </tr>
                                <tr>
